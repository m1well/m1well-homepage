...
description:
  ...
  pages and start building systems. In this deep dive, we explore Atomic Design
  - a methodology that breaks interfaces into Atoms, Molecules, and Organisms.
  We’ll apply this theory to a real-world Login scenario using modern Angular
  (v19+) features like Signals and Standalone Components, and show you how to
  enforce it at scale with Nx."
