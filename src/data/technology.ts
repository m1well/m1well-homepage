...
export const stacks: StackItem[] = [
  ...
  {
    name: 'Tools',
    text: 'Fast, precise daily work in IntelliJ IDEA and Git, these days paired with AI-assisted development in Claude Code for scaffolding, refactoring and reviews.',
    icon: 'fas fa-tools',
    techs: [
      {
  ...
  {
    name: 'Concepts',
    text: 'Keeping code alive long-term with Clean Code principles and automated tests (JUnit, ArchUnit), and keeping teams in sync with Scrum routines that people actually stick to.',
    icon: 'fas fa-brain',
    techs: [
      {
