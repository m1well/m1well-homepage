...
export const stacks: StackItem[] = [
  {
    name: 'Fullstack Dev',
    text: 'Building scalable backends with Spring Boot (Java & Kotlin) and the Angular frontends that talk to them - one stack, from the database up to the browser.',
    icon: 'fas fa-code',
    techs: [
      {
  ...
  {
    name: 'DB & Messaging',
    text: 'Relational data models in PostgreSQL or MySQL, and event-driven communication over RabbitMQ or Kafka when services should not have to wait for each other.',
  ...
  {
    name: 'DevOps',
    text: 'Containers on Docker and Kubernetes, delivery through automated CI/CD pipelines (e.g. Jenkins), and OpenTelemetry so you can see what the system is actually doing in production.',
    icon: 'fas fa-server',
    techs: [
      {
  ...
  {
    name: 'Craft & Tools',
    text: 'IntelliJ IDEA and Git all day, with Claude Code alongside. Clean Code principles and automated tests with JUnit and ArchUnit are what keep the code maintainable.',
    icon: 'fas fa-tools',
    techs: [
      {
        link: 'https://claude.com/product/claude-code',
        name: 'Claude Code',
        src: '/techlogos/logo_claude.png',
      },
      {
...
export const skills: SkillItem[] = [
  ...
  },
  {
    ...
    specific: [
      ...
      { name: 'NX', barValue: 55, proficiency: 'Professional' },
  ...
  },
  {
    category: 'Tools',
    specific: [
      { name: 'Claude Code', barValue: 70, proficiency: 'Senior' },
      ...
      { name: 'GitHub Actions', barValue: 55, proficiency: 'Professional' },
