...
export const jobs: JourneyItem[] = [
  {
    ...
    description:
      'Fullstack development of a digital claims platform using Spring Boot with Kotlin for the backend and Angular/Nx for the frontend, deployed via GitOps on Kubernetes and monitored using OpenTelemetry. Day-to-day work is AI-assisted, with Claude Code as a fixed part of the toolchain for feature work and code refactoring.',
    active: true,
    events: [],
  },
  {
