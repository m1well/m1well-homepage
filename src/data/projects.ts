type ProjectItem = {
  ...
  tags: string[];
  ribbon?: string;
} & ({ githubLink: string } | { websiteLink: string });

export const projects: ProjectItem[] = [
  {
    title: 'MaverickWave',
    description1:
      'A lightweight CSS framework for responsive websites, with a component set, dark mode and theming through custom properties.',
    description2:
  ...
  },
  {
    title: 'brb',
    description1:
      'Open brb.m1well.com and take a short guided break right in your browser - breathing, neck and shoulder stretches, eye drills.',
    description2:
      'For everyone in IT the AI hype is wearing down - no phone app, no install, no account, no excuse.',
    image: '/images/brb_logo.png',
    imageAlt: 'brb image',
    lastUpdated: '2026-09-23',
    websiteLink: 'https://brb.m1well.com',
    tags: ['TypeScript', 'Astro', 'Web Audio', 'SVG', 'localStorage'],
  },
  {
    title: 'TopoMap',
    description1:
